...
public abstract class Move {
    ...
    public final int getPieceDestination() {
        return this.pieceDestination;
    }

    public final Piece getPieceMove() {
    ...
    public static abstract class CastleMove extends Move {
        ...
        protected CastleMove(Board board, Piece movePiece, int pieceDestination, Rook castleRook, int castleRookPosition,
