...
import com.chess_POO.board.MoveAttack;
import com.chess_POO.board.MoveNormal;
...
public abstract class Piece {
    ...
    public final Color getPieceColor() {
        return this.pieceColor;
    }

    public final Object getPieceType() {
        return this.pieceName;
    }

    public final Integer getPiecePosition() {
    ...
    protected final Move tryCreateMove(final Board board, final int moveDestination) {
